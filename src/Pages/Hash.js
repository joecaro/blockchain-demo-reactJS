    ...
    <>
      <Main>
        ...
        <p>
          ...
          what we will later call blocks.
        </p>
        <p>
        ...
        <p>
          ...
          by passing that data through a hashing function. Hashing Functions
          have some unique and important properties:
        </p>
        ...
        <ul>
          <li>
            <h3>Speed</h3>
            <p>
              Hashing Functions should be computationally effecient. Ideally
              these functions should produce a result in under a second.
            </p>
          </li>
          <li>
          ...
          <li>
            <h3>Deterministic</h3>
            <p>
              Every time you produce a hash for the same input, you should get
              the same output.
            </p>
          </li>
          <li>
